...
-- Ejercicio 8: Contar el número de clientes en Brasil.
   select count("Country") from "Customer" c where "Country" = 'Brazil'
...
select count("Title")
from "Employee" e where "Title" = 'Sales Support Agent'
...
select stddev("Milliseconds") from "Track" t 

-- Ejercicio 15: Calcular la varianza de la duración de las pistas.
select variance("Milliseconds") from "Track" t 
